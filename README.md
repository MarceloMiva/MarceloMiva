...
```
  ┌─────────────────────────────────────────────────────┐
  │  Building offensive security tools from Lagos, NG   │
  │  Turning theory into working code, one CTF at a time│
  └─────────────────────────────────────────────────────┘
```
...
- [**Portfolio**](https://marcelomiva.github.io)
- 📍 Lagos, Nigeria
...
![FTK Imager](https://img.shields.io/badge/FTK_Imager-grey?style=flat-square)
...
### 🔴 [DARE — Dynamic Attack & Recon Engine](https://github.com/MarceloMiva/DARE)
> Modular CLI penetration testing toolkit built in Python

- Recon & OSINT · Port Scanning · Web Enumeration
- Hash Tools · Encoder/Decoder · Exploit Helper · CVE Live Lookup
- 🌐 **Live:** [marcelomiva.github.io/DARE](https://marcelomiva.github.io/DARE/)

---

### 🔵 [AYO — Attack Your Offenders](https://github.com/MarceloMiva/AYO)
> Offensive security framework for authorized testing & CTFs

- Phishing Kit Generator · Steganography Suite
- Social Engineering Toolkit · Password Tools
- Network Tools · Crypto Tools (AES-256, Vigenère, XOR & more)
...
[![GitHub](https://img.shields.io/badge/GitHub-MarceloMiva-181717?style=flat-square&logo=github)](https://github.com/MarceloMiva)
[![DARE Live](https://img.shields.io/badge/DARE-Live_Demo-00ff41?style=flat-square)](https://marcelomiva.github.io/DARE/)
